...
public class LevelGenerator {
    ...
    */
     ...
     * levelin konstruktorissa itsessään luodaan jo dimensioiden puitteissa oleva
     * kartta, jossa on pelkkiä Empty() -blockeja. Kuitenkin LevelGenerator luokkanaan
     * on oikeutettu: sitä tarvitaan
     * mikäli lisättäisiin toisenlaisten karttojen generointi, joissa jo
     * valmiiksi olisi muitakin block -tyyppejä.
